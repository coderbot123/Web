  ...
  <div id="top" >
      <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
          <div>
            ...
            <img class="img-responsive" alt="Brand" src="img/booklogo.png" style="width: 147px; margin: 0px; margin-top: -20px;">
        </a> -->
              <form role="search" method="POST" action="Result.php">
                  <input type="text" class="form-control" name="keyword" style="width:80%;margin:20px 10% 20px 10%;" placeholder="Tìm kiếm sách, tác giả hoặc tiểu thuyết..">
              </form>
          </div>
      </div>
<?php
    ...
    echo '<div class="container-fluid" id="books">
        <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h4 style="color:#00B9F5;text-transform:uppercase;"> Tìm thấy  '. mysqli_num_rows($result) .' sản phẩm </h4>
           </div>
        </div>';
