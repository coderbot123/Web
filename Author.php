...
<head>
    ...
    <style>
        ...
        .sort-form {
    float: left; /* Makes the form align to the left */
        ...
        <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
            <div>
                <form role="search" action="Result.php" method="post">
                    <input type="text" class="form-control" name="keyword" placeholder="Tìm kiếm sách, tác giả hoặc tiểu thuyết...." style="width:80%;margin:20px 10% 20px 10%;">
                </form>
            </div>
        </div>
